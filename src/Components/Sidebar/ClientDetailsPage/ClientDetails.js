...
const ClientDetails = ({ isScreenShown, setScreenShown, item }) => {
	...
	return (
		<div
			className={
				isScreenShown ? "ClientDetails expanded" : "ClientDetails"
			}>
						...
						<div className='truckNameStatus'>
							...
							<div className='truckStatus'>
								<div className='truck-img'>
									<img
										src='/images/clientDetailsTruck.svg'
										alt=''
									/>
								</div>
								<div className='statusDetails'>
									<p>{item.truckStatus}</p>
								</div>
							</div>
						</div>
					</>
				...
				<div className='companyNameImg'>
					{item?.company?.map((value) => (
						<>
							<div
								className={
									comptoggleState === value.id
										? "companyNameImgContainer active-comp"
										: "companyNameImgContainer"
								}
								style={{ cursor: "pointer" }}
								onClick={() =>
									handleTabChange(value.id, value)
								}>
								<div className='companyImg'>
									<img
										className='img-comp'
										src='/images/companyImg.svg'
										alt=''
									/>
									<img
										className='cancelBtn'
				...
				<div className='clientDetailsContainer2'>
					...
					<div className='singleCompanyDetails'>
						...
						<div className='mainComapnyDetails'>
							<h2>{item?.company[tabId]?.company1}</h2>
							<p>View Details</p>
						</div>
					</div>
